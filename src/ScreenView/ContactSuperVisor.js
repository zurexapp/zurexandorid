...
import {borderColor, greencolor, maincolor} from '../assets/Colors';
...
const ContactSuperVisor = ({navigation}) => {
  ...
  const getContactData = async () => {
    setisLoading(true);
    const check = await getSupervisor('supervisor');
  ...
  return (
    <View style={styles.fillscreenbg}>
      <CurvedHeaderComp
        name={textStrings.contactUsBtnTxt}
        iconName1={'list'}
          ...
          <View style={styles.contactUsMainDiv}>
            <View style={styles.imageContainer}>
              ...
              <Text
                ...
                {textStrings.contactUsSupervisor}
              </Text>
            </View>
