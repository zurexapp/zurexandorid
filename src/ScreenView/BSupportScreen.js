...
const BSupportScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.fillscreenbg}>
      <CurvedHeaderComp
        name={textStrings.supportServiceTxt}
        iconName1={'left'}
      ...
      <View style={styles.otherContent}>
        ...
        <CustomDropDownBtn
          title={textStrings.choseServiceType}
          value={selectedValue}
          onCangeValue={text => setselectedValue(text)}
          listData={[
            {id: 0, title: 'All', value: 'all'},
            {id: 1, title: 'Warranties', value: 'warranties'},
            {id: 2, title: 'Battery charging', value: 'batteryCharging'},
          ]}
          isDropDown={true}
          isSmallDesign={true}
        />
